    ...
    >
      ...
      <div className="flex flex-col flex-1 px-4 pt-3.5 pb-3 gap-2">
        ...
        <div className="flex flex-wrap items-center gap-1.5 mt-auto pt-1">
          ...
          {book.quantity != null && (
            <span className="inline-flex items-center gap-1 text-[11px] text-slate-400 border border-slate-100 bg-slate-50 px-2 py-0.5 rounded-md font-medium">
      ...
      <div className="flex items-center justify-between gap-2 px-4 py-3 border-t border-slate-100 bg-slate-50/60">
        ...
        <div className="flex items-baseline min-w-0 gap-1">
          {isFree ? (
            ...
            <>
              <span className="text-[17px] font-extrabold text-slate-800 leading-none tabular-nums">
                {new Intl.NumberFormat('uz-UZ').format(price)}
              </span>
              <span className="text-[11px] text-slate-400 leading-none">{t('library.card.currency')}</span>
            </>
          )}
        </div>
