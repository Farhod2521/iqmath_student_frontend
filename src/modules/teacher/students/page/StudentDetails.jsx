          ...
          <div className="lg:col-span-2 bg-white p-6 rounded-xl border border-gray-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <div>
                ...
                <p className="text-xs text-gray-400">{studentData.last_payment_date} {studentData.last_payment_time}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-x-3 gap-y-1 items-center mt-1">
                  <span className="flex items-center text-sm text-yellow-600"><div className="w-2 h-2 rounded-full bg-yellow-400 mr-2"></div>{studentData.payment_status_count?.pending} {t("pending")}</span>
                  <span className="flex items-center text-sm text-green-600"><div className="w-2 h-2 rounded-full bg-green-400 mr-2"></div>{studentData.payment_status_count?.success} {t("success")}</span>
                  <span className="flex items-center text-sm text-red-600"><div className="w-2 h-2 rounded-full bg-red-400 mr-2"></div>{studentData.payment_status_count?.failed} {t("failed")}</span>
                </div>
              </div>
               <div>
