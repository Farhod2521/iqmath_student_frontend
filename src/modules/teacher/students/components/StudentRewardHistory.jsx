                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-3 flex-1">
                      <div className="text-[#5D87FF]">{getRewardTypeIcon(reward.reward_type)}</div>
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <h3 className="font-semibold text-gray-900">{reward.student_name}</h3>
                          <span
                            className={`px-2 py-1 rounded-full text-xs font-medium ${getRewardTypeColor(reward.reward_type)}`}
                          >
                            {reward.reward_type_display}
                          </span>
                        </div>
                        <p className="text-gray-600 text-sm mb-2">{reward.reason}</p>
