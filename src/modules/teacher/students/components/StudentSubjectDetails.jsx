...
const StudentSubjectDetails = () => {
    ...
    return (
        <Dashboard  headerTitle={t("students")}>
            <div className="p-6">
                            ...
                            <tbody>
                                {chapters.map((chapter, index) => (
                                    <tr 
                                        ...
                                        className={`border-t transition-colors duration-200 cursor-pointer ${selectedChapter?.chapter_id === chapter.chapter_id ? 'bg-blue-50' : 'hover:bg-gray-50'}`}
                                    >
                                        <td className={`p-3 w-10 text-center font-medium ${selectedChapter?.chapter_id === chapter.chapter_id ? 'text-blue-600' : 'text-gray-500'}`}>{index + 1}</td>
                                        <td className={`p-3 font-medium ${selectedChapter?.chapter_id === chapter.chapter_id ? 'text-blue-600' : ''}`}>{chapter.chapter_name}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
