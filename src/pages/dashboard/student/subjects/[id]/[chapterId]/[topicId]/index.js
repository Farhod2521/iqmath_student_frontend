...
const Index = () => {
  ...
  return (
    <Dashboard headerTitle={"Темы/разделы"}>
        ...
        <div className="col-span-12 border border-[#E9E9E9] rounded-[12px] mx-[169px] relative">
          <div className="relative flex items-center justify-between w-full overflow-hidden">
            ...
            <div className="cursor-pointer" onClick={() => setOpen(!open)}>
              <h1 className="text-[17px] text-center">
                {i18n.language === "uz"
                  ? selectedTopic?.name_uz
                  : selectedTopic?.name_ru}
              </h1>
            </div>
          ...
          <div className="flex justify-between py-[12px] px-[24px]">
            ...
            <div className="flex items-center gap-x-[8px]">
              ...
              <Link
                href={`/dashboard/student/subjects/${id}/${chapterId}/${topicId}/question`}
              >
          ...
          <div className="py-[22px] px-[24px]">
            <div className=" mx-auto bg-white">
              {i18n.language === "uz"
                ? parse(selectedTopic?.content_uz || "")
                : parse(selectedTopic?.content_ru || "")}
            </div>
          </div>
          ...
          {showPlayer && (
            <VideoPlayer
              url={
                i18n.language === "uz"
                  ? selectedTopic?.video_url_uz
                  : selectedTopic?.video_url_ru
              }
              title={
                i18n.language === "uz"
                  ? selectedTopic?.name_uz
