  ...
  return (
    <LayoutAdmin title="Предметная и тестовая часть">
      <section className="flex items-center space-x-[12px]">
        ...
        <RightIcon color="#BCBFC2" />
        <Link className="text-[#0256BA] text-sm font-semibold" href={`/dashboard/teacher/subjects/${id}`}>
          Bob va mavzular
        </Link>
      </section>
              ...
              <div className="space-y-[15px] my-[20px]">
                <div className="px-[16px] mt-[18px] mb-[9px]">
                  ...
                  <CKEditor
                    ...
                    onChange={(event) => setQuestionText(event.editor.getData())}
                    config={{
                      toolbar: [
                ...
                <div className="px-[16px] mt-[18px] mb-[9px]">
                  ...
                  <CKEditor
                    initData={questionTextRu}
                    onChange={(event) => setQuestionTextRu(event.editor.getData())}
                    scriptUrl="https://cdn.ckeditor.com/4.25.1-lts/standard/ckeditor.js"
                    config={{
                      toolbar: [
                        ['Bold', 'Italic', 'Strike'], // Text styling
                        ['BulletedList', 'NumberedList', 'Outdent', 'Indent', 'Blockquote'], // Lists and indentation
