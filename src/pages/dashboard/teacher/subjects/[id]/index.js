    ...
    <MainWrapper title="Математика">
      <div className="font-sf">
        <div className="flex justify-between mb-2">
          ...
          <Button
            classname={
              "hover:bg-[#2F66FF] transition-all duration-300 scale-100 active:scale-95"
            }
            onclick={() => {
                ...
                <thead>
                  <tr className="border-b border-b-[#E9E9E9] p-[12px]">
                    <th className="p-[12px] text-center">
                      <button
                        onClick={() =>
                          setIsChaptersDragEnabled((prev) => !prev)
                        }
                  ...
                  <tbody>
                    {chapters.map((chapter, index) => {
                      ...
                      return (
                        ...
                        >
                          <td className="p-[12px] text-center w-[40px]">
                            {index + 1}
                          </td>
                        ...
                        <thead>
                          <tr className="border-b border-b-[#E9E9E9] p-[12px]">
                            <th className="p-[12px] text-center">
                              <button
                                onClick={() =>
                                  setIsTopicsDragEnabled((prev) => !prev)
                                }
                                className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-gray-100"
                                title="Tartiblash"
                              >
                              ...
                              >
                                ...
                                <td
                                  ...
                                  onClick={(e) => {
                                    e.stopPropagation;
                                    router.push(
                                      `/dashboard/teacher/subjects/${id}/${selectedId}/${topic.id}`
                                    );
                                  }}
                                >
                                  {i18n.language === "uz"
