      ...
      <div className={' flex flex-grow items-center justify-center '}>
        ...
        <div className="w-full max-w-sm md:max-w-md lg:max-w-lg h-auto bg-white  mx-auto md:my-[30px] my-[50px] rounded-[8px] p-6 md:p-8  ">
          ...
          <div className="w-full mt-[30px]">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-[10px] text-[17px]  rounded-[4px]">
              {/* Ism */}
              <div className="">
                <input
                  type="text"
              ...
              <div>
                ...
                {submitError?.phone && <p className="text-red-500 text-sm mt-1">{submitError.phone}</p>}
              </div>
