...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white font-sf relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container relative z-10">
        ...
        <div className="pt-16 pb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            {/* Contact Info */}
            <div className="lg:col-span-4">
              <h3 className="text-white font-semibold text-base mb-4">Aloqa ma'lumotlari</h3>
              <ul className="space-y-4">
                {contactInfo.map((contact, idx) => (
                  <li key={idx}>
                    ...
                    >
                      <div className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 transition flex-shrink-0">
                        <Image
                          src={contact.icon}
                          alt={contact.label}
                          width={20}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-800/50 rounded-lg border border-gray-700">
                ...
                <span className="text-xs text-gray-400 font-medium">Xavfsiz to'lov</span>
              </div>
      ...
      <button
        ...
        className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full shadow-lg hover:shadow-xl flex items-center justify-center text-white transition transform hover:scale-110 z-50 group"
        aria-label="Yuqoriga"
      >
        <svg
