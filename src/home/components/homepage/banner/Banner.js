        ...
        <Grid container spacing={3} justifyContent="center" mb={4}>
          ...
          <Grid size={{ xs: 12, lg: 7 }} textAlign="center">
            ...
            >
              ...
              >
                <Image src={iconPlay} alt="icon" width={40} height={40} /> See how it works
              </Button>
              ...
              {Frameworks.map((fw, i) => (
                <Tooltip title={fw.name} key={i}>
                  <Box
                    ...
                    display="flex"
                    sx={{
                      boxShadow: (theme) => (theme.palette.mode === 'dark' ? null : (theme) => theme.shadows[10]),
                      backgroundColor: (theme) => (theme.palette.mode === 'dark' ? '#1f2c4f' : 'white')
                    }}
                    alignItems="center"
                    justifyContent="center"
                    borderRadius="16px"
