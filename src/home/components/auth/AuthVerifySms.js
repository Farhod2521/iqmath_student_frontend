...
// function AuthVerifySms() {
//   return <div>AuthVerifySms</div>
// }

// export default AuthVerifySms
...
const AuthVerifySms = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      clearInterval(interval)
      localStorage.removeItem('timerForgetPassword')
      localStorage.removeItem('timerTimestampForgetPassword')
    }
  }, [])
